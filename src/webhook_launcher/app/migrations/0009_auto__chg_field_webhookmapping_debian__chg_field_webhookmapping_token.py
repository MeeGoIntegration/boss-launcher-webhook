...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebHookMapping.debian'
        db.alter_column('app_webhookmapping', 'debian', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'WebHookMapping.token'
        db.alter_column('app_webhookmapping', 'token', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'WebHookMapping.debian'
        db.alter_column('app_webhookmapping', 'debian', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'WebHookMapping.token'
        db.alter_column('app_webhookmapping', 'token', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)'})
        },
        'app.relaytarget': {
