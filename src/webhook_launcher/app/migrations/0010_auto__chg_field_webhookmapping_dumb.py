...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebHookMapping.dumb'
        db.alter_column('app_webhookmapping', 'dumb', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'WebHookMapping.dumb'
        db.alter_column('app_webhookmapping', 'dumb', self.gf('django.db.models.fields.CharField')(max_length=2))
