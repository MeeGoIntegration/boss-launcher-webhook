...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.gated'
        db.add_column('app_project', 'gated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.gated'
        db.delete_column('app_project', 'gated')
    ...
    models = {
        ...
        'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'})
        },
        'app.relaytarget': {
