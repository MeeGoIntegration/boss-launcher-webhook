...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LastSeenRevision.emails'
        db.add_column('app_lastseenrevision', 'emails',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LastSeenRevision.emails'
        db.delete_column('app_lastseenrevision', 'emails')
    ...
    models = {
        ...
        'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)'})
        },
        'app.relaytarget': {
