...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebHookMapping.dumb'
        db.add_column('app_webhookmapping', 'dumb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'WebHookMapping.comment'
        db.add_column('app_webhookmapping', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebHookMapping.dumb'
        db.delete_column('app_webhookmapping', 'dumb')

        # Deleting field 'WebHookMapping.comment'
        db.delete_column('app_webhookmapping', 'comment')
