...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WebHookMapping', fields ['project', 'obs', 'package']
        db.create_unique(u'app_webhookmapping', ['project', 'obs_id', 'package'])


    def backwards(self, orm):
        # Removing unique constraint on 'WebHookMapping', fields ['project', 'obs', 'package']
        db.delete_unique(u'app_webhookmapping', ['project', 'obs_id', 'package'])
    ...
    models = {
        ...
        u'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'})
        },
        u'app.relaytarget': {
