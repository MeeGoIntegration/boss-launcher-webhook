...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_relaytarget', (
        ...
        db.send_create_signal(u'app', ['RelayTarget'])

        # Adding M2M table for field sources on 'RelayTarget'
        db.create_table(u'app_relaytarget_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('relaytarget', models.ForeignKey(orm[u'app.relaytarget'], null=False)),
            ('vcsnamespace', models.ForeignKey(orm[u'app.vcsnamespace'], null=False))
        ))
        db.create_unique(u'app_relaytarget_sources', ['relaytarget_id', 'vcsnamespace_id'])

        # Adding field 'LastSeenRevision.payload'
        db.add_column(u'app_lastseenrevision', 'payload',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VCSNameSpace.default_project'
        db.add_column(u'app_vcsnamespace', 'default_project',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'app_relaytarget')

        # Removing M2M table for field sources on 'RelayTarget'
        db.delete_table('app_relaytarget_sources')

        # Deleting field 'LastSeenRevision.payload'
        db.delete_column(u'app_lastseenrevision', 'payload')

        # Deleting field 'VCSNameSpace.default_project'
        db.delete_column(u'app_vcsnamespace', 'default_project_id')
    ...
    models = {
        ...
        u'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)'})
        },
        u'app.relaytarget': {
