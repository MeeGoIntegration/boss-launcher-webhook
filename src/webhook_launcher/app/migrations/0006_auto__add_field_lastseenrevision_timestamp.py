...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LastSeenRevision.timestamp'
        db.add_column('app_lastseenrevision', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LastSeenRevision.timestamp'
        db.delete_column('app_lastseenrevision', 'timestamp')
    ...
    models = {
        ...
        'app.queueperiod': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 5, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 5, 24, 0, 0)'})
        },
        'app.vcsnamespace': {
